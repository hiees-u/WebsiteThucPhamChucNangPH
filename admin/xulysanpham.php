                    ...
                    ?>
                        <div class="col-md-4">
                            ...
                            <form action="" method="post" enctype="multipart/form-data"> 
                                ...
                                <input type="file" class="form-control" name="hinhanh"><br>
                                <label>Gía</label>
                                <input type="text" class="form-control" name="giasanpham" placeholder="Gía sản phẩm"><br>
                                <label>Gía khuyến mãi</label>
                                <input type="text" class="form-control" name="giakhuyenmai" placeholder="Gía khuyến mãi"><br>
                                <label>Số lượng</label>

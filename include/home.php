				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<?php
									$spl_product = mysqli_query($con, "SELECT * FROM tbl_sanpham ORDER BY sanpham_id DESC");
									while($row_sanpham = mysqli_fetch_array($spl_product)){
								...
								<div class="scroll">
									...
									<div class="row">
										...
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											...
											<a href="" class="price-mar mt-2"><?php echo number_format($row_product_sidebar['sanpham_gia']) . 'VNĐ'?></a>
										</div>
									</div>	
									<?php
										}

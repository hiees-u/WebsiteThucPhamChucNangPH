			...
			<div class="row">
					...
					<div class="join-agile text-left p-4">
						<div class="row">
							<div class="col-sm-7 offer-name">
								<h6>Viên uống Keiko Bilberon Bổ mắt</h6>
								<h4 class="mt-2 mb-3">Thuốc</h4>
								<p>Khuyến mãi 25%</p>
							</div>
							<div class="col-sm-5 offerimg-w3l">
								<img src="images/off6.jpg" alt="" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 mt-lg-0 mt-5">
					<div class="join-agile text-left p-4">
						<div class="row ">
							<div class="col-sm-7 offer-name">
								<h6>Men vi sinh Health Aid Bifina R </h6>
								<h4 class="mt-2 mb-3">Thực phẩm chức năng</h4>
								<p>Miễn phí giao hàng</p>
							</div>
							<div class="col-sm-5 offerimg-w3l">
								<img src="images/off7.webp" alt="" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
